DOCKER_VERSION ?= 0.5.1-1
GITRECEIVE_URL ?= https://raw.github.com/progrium/gitreceive/master/gitreceive
SSHCOMMAND_URL ?= https://raw.github.com/progrium/sshcommand/master/sshcommand
PLUGINHOOK_URL ?= https://s3.amazonaws.com/progrium-pluginhook/pluginhook_0.1.0_amd64.deb
DOCKER_URL ?= https://launchpad.net/~dotcloud/+archive/lxc-docker/+files/lxc-docker_$(DOCKER_VERSION)_amd64.deb
...
docker: aufs
	wget -qO /tmp/lxc-docker_$(DOCKER_VERSION)_amd64.deb ${DOCKER_URL}
	dpkg --force-depends -i /tmp/lxc-docker_$(DOCKER_VERSION)_amd64.deb && apt-get install -f -y
